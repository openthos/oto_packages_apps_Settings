...
public class ScreenLockTimeSettings extends SettingsPreferenceFragment{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.screen_lock_time_settings);
        mSharedPreferences = getActivity().getSharedPreferences("lockcharge", Context.MODE_PRIVATE);
        mCharging = (ListPreference)findPreference("screen_lock_time_charging");
        mNotCharging = (ListPreference)findPreference("screen_lock_time_notcharging");
        int chargeTime = mSharedPreferences.getInt("lockcharging",1);
        int noChargeTime = mSharedPreferences.getInt("nolockcharging",0);
        if (isCharging()) {
...
//                                               mTimes[index]);
                    ...
                    editor.putInt("lockcharging", index);
                    editor.commit();
...
//                                               mTimes[index]);
                    ...
                    SharedPreferences.Editor editor = mSharedPreferences.edit();
                    editor.putInt("locknocharging", index);
                    editor.commit();
